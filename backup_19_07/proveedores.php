          ...
          while ($fila = $resultado_paginado->fetch_assoc()) {
            ...
            echo "<td class='td-opciones'>";
              echo "<a href='editar_proveedor.php?id={$fila['ID_proveedor']}' class='btn btn-sm btn-warning'><i class='bi bi-pencil'></i></a> 
                    <a href='../controllers/eliminar_proveedor.php?id={$fila['ID_proveedor']}&csrf_token=" . csrf_token() . "' onclick=\"return confirm('¿Estás seguro de eliminar este proveedor?')\" class='btn btn-sm btn-danger'><i class='bi bi-trash'></i></a>";
            echo "</td>";
            }
            echo "</tr>";
          }
