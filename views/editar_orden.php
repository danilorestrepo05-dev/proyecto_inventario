...
<script>
    ...
    document.getElementById('formOrden').addEventListener('submit', function(e) {
        ...
        localStorage.removeItem('svt_editar_orden_draft');
    });

    // === LOCALSTORAGE: Guardar/Cargar borrador ===
    const STORAGE_KEY = 'svt_editar_orden_draft';
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (raw) {
            if (confirm('Tienes cambios sin guardar en esta orden. ¿Deseas restaurarlos?')) {
