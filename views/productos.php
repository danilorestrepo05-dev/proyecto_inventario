        ...
        if ($total_registros > 0) {
          while ($fila = $resultado_paginado->fetch_assoc()) {
            ...
            echo "<td class='td-opciones'>";
              ...
              echo "<a href='../controllers/eliminar_producto.php?id={$fila['ID_producto']}&csrf_token=" . csrf_token() . "$inactivos_param' class='btn btn-sm $clase_toggle' title='$titulo_toggle'><i class='bi $icono_toggle'></i></a>";
            echo "</td>";
            }
            echo "</tr>";
          }
